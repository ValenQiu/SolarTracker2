...
"""
This is the Class for PTZ Control, including the connection and control
In this class, there are many useful class functions and they are easy to use
The control follows the Pelco-D 
"""
